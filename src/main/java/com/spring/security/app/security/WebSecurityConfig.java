...
import com.spring.security.app.service.MyUserDetailsService;
        ...
        http
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET,"/api/users/{id}/**")
                        .access("@userDetailsService.checkUserId(authentication, #id)")
                    .antMatchers(HttpMethod.POST, "/api/users/{id}/**")
                        .access("@userDetailsService.checkUserId(authentication, #id)")
